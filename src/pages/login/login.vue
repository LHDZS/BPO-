<template>
  <div class="login">
    ...
    <div style="width:94%;" v-if="loginType">
      <div class="dialog">
        <div class="name">
        ...
        <div class="input">
          <el-input v-model="phone" prefix-icon="el-icon-user" placeholder="请输入公司账号/手机号"></el-input>
        </div>
    ...
    <div class="dialog" v-else>
      <div class="name" style="cursor: pointer;" @click="loginType = true">
        <i class="el-icon-back"></i>&nbsp;找回密码
      </div>
      <div class="laber">手机号：</div>
      <div class="input">
        <el-input v-model="phone2" placeholder="请输入公司账号/手机号"></el-input>
      </div>
      <div class="laber">验证码：</div>
      <div class="validation">
        <div class="left">
          <el-input v-model="phoneSms" placeholder="请输入手机号验证码"></el-input>
        </div>
        <div class="obtain" @click="validationSms(phone2)">{{countdownHtml}}</div>
      </div>
...
.login {
  width: 100%;
  height: 100%;
  background: url("https://gsb-zc.oss-cn-beijing.aliyuncs.com//zc_wxapplet_1585031928263.jpg")
    no-repeat;
